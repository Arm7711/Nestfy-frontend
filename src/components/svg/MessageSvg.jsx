export default function MessageSvg({ className = 'icon' }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" className={className} role="presentation" focusable="false">
